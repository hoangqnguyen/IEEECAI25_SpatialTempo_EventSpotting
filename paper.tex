...
Also, ball location tracking is a well researched topic. This means that we could use ball detection module such as vanyis to get the ball location without human labour.
\begin{figure}[htbp]
